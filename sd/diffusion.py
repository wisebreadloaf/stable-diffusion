...
class TimeEmbedding(self, n_embd: int):
...
class UNET_AttentionBlock(nn.Module):
    def __init__(self, n_head: int, n_embd: int, d_context = 768):
        ...
        self.linear_geglu_2 = nn.Linear(channels, 4 * channels , channels)
...
class UNET_residualBlock(nn.Module):
    ...
    def forward(self, feature, time):
        ...
        featire = self.conv_feature(feature)
        time = F.silu(time)
...
class SwitchSequential(nn.Sequential):
    def forward(self, x: torch.Tensorm context: torch.Tensor,
...
class UNET(nn.Module):
    def __init__(self):
        ...
        self.encoders = nn.Module([
            ...
            SwitchSequential(UNET_residualBlock(320, 320),
                             UNET_AttentionBlock(8, 40)),
            SwitchSequential(nn.Conv2d(320, 320,
                                       kernel_size=3,
                                       stride=3,
                                       padding=1)),
            ...
            SwitchSequential(UNET_residualBlock(320, 640),
                             UNET_AttentionBlock(8, 80)),
            SwitchSequential(nn.Conv2d(640, 640,
                                       kernel_size=3,
                                       stride=3,
                                       padding=1)),
            ...
            SwitchSequential(UNET_residualBlock(1280, 1280),
                             UNET_AttentionBlock(8, 160)),
            SwitchSequential(nn.Conv2d(1280, 1280,
                                       kernel_size=3,
                                       stride=3,
                                       padding=1)),
            SwitchSequential(UNET_residualBlock(1280, 1280)),
...
class Diffusion(nn.Module):
    ...
    def forward(self, latent: torch.Tensor,
                context: torch.Tensor, time: torch.Tensor):
