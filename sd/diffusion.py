    ...
    def __init__(self):
        ...
        self.encoders = nn.Module(
            [
                ...
                SwitchSequential(
                    nn.Conv2d(320, 320, kernel_size=3, stride=3, padding=1)
                ),
                SwitchSequential(
                ...
                SwitchSequential(
                    nn.Conv2d(640, 640, kernel_size=3, stride=3, padding=1)
                ),
                SwitchSequential(
                ...
                SwitchSequential(
                    nn.Conv2d(1280, 1280, kernel_size=3, stride=3, padding=1)
                ),
